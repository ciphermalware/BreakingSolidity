...
contract SignatureMalleabilityTest is Test {
    ...
    function testRealisticProofManipulationAttack() public {
        ...
        // This demonstrates why tracking by proof hash is flawed
    ...
    function testRealSignatureMalleabilityVulnerability() public {
        ...
        // Instead of manipulating Alice's state it show how Bob can exploit
        ...
        // by manipulating the array structure 
    ...
    /**
     * @dev Helper function to verify Merkle proof 
     */
